...
void navigateToPaymentDetails(Payment payment, BuildContext context) {
   var route = MaterialPageRoute(builder: (_) => PaymentDetailPage(payment: payment));
   Navigator.push(context, route);
}

Widget renderPaymentItem(Payment paymentItem, context) {
  return GestureDetector(
    onTap: (){
        navigateToPaymentDetails(paymentItem, context);
    },
    child: Padding(
            ...
            child: Column(mainAxisSize: MainAxisSize.max, children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                      paymentItem.is_confirmed ? 'Подвержден' : 'Ожидание')
                ],
              ),
            ]),
          ),
        ...
        body: Observer(builder: (context) {
          ...
          return RefreshIndicator(
            ...
            child: ListView.builder(
                ...
                itemBuilder: (_, index) =>
                    renderPaymentItem(userStore.userPayments[index], context)),
          );
        }));
  }
}
